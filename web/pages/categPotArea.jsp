...
<table class="MenuOption2" align="center" border="0" width="100%" cellspacing="0" cellpadding="0">
  ...
  <p align="center">&nbsp;</p>
<div align="center">
<form action="/unicsul/principal?acao=CategPotAreaCommand" method="post" runat="server">
...
try {
	...
	if(codCent3==0){
		...
		for(int j=0;j<listaAreas.size();j++ ) { 
	  	...
	  	areaDao = new AreasDao();
	  	listaAreas = areaDao.areas(codCent);
		areaVO = new AreasVO();
 ...
 if(listaAreas != null)listaAreas.clear();
 listaAreas = null;
 areaDao = null;
 areaVO = null;
}
					  ...
					  try {
							...
							for(int i=0;i<listaSubCateg.size();i++ ) { 
							    ...
							    %>
								 ...
								 listaPot = potDao.CategPot3(auxSubCat,codCent2);
